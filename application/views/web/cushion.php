  ...
  <section class="Shop-section pt-115">
      ...
      <div class="row justify-content-center">
          ...
          <div class="shop-detail-image">
            <div class="detail-slider-1">
              <div class="slide-item">
                <div class="image-box">
                  <a href="#">
                  <img class="popup-video"  height="550" width="100%" src="<?php echo base_url();?>assets/shapes/cushion.png">
                   </img>
                   </a>
        ...
        <div class="col-lg-7">
          <div class="shop-detail-content">
            <h3 class="product-title mb-20">Cushion Shape</h3>
            ...
            <form method="post" action="<?php echo base_url();?>Main/send_diamond">
                    <input type="hidden" name="shape" value="Cushion">
    ...
    <label for="SI1" >SI1
            ...
            <center>
              ...
              <div class="color-box">
              <input type="text" name="size" placeholder="Size"  placeholder="Contact Number" ></center>
