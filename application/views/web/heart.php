      ...
      <div class="row justify-content-center">
          ...
          <div class="shop-detail-image">
            <div class="detail-slider-1">
              <div class="slide-item">
                <div class="image-box">
                  <a href="#">
                  <iframe class="popup-video" style="background:grey;" height="550" width="100%" src="https://view.gem360.in/gem360/3007201005-KM1-173A/gem360-3007201005-KM1-173A.html">
                   </iframe>
                   </a>
        ...
        <div class="col-lg-7">
          <div class="shop-detail-content">
            <h3 class="product-title mb-20">Heart Shape</h3>
            ...
            <form method="post" action="<?php echo base_url();?>Main/send_diamond">
                    <input type="hidden" name="shape" value="Heart">
