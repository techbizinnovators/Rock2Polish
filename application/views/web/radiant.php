      ...
      <div class="row justify-content-center">
          ...
          <div class="shop-detail-image">
            <div class="detail-slider-1">
              <div class="slide-item">
                <div class="image-box">
                  <a href="#">
                  <img style="background:#1cb19;" height="550" width="100%" src="<?php echo base_url();?>assets/shapes/radiant.png">
                   </img>
                   </a>
        ...
        <div class="col-lg-7">
          <div class="shop-detail-content">
            <h3 class="product-title mb-20">Radiant Shape</h3>
            ...
            <form method="post" action="<?php echo base_url();?>Main/send_diamond">
                    <input type="hidden" name="shape" value="Radiant">
